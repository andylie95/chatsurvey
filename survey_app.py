...
class SurveyApp:
    ...
    def submit_answer_on_change(self):
        ...
        self.submit_answer(st.session_state.current_question_text, answer)
...
if __name__ == "__main__":
    ...
    if not st.session_state.language_selected:
        ...
        if st.session_state.current_question < len(app.questions):
            question_row = app.questions.iloc[st.session_state.current_question]
            st.session_state.current_question_text = f"{question_row['prompt']} {question_row['question']}"
