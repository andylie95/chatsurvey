...
class SurveyApp:
    ...
    def save_conversation(self):
        ...
        st.download_button("Download Responses as XLSX", data=excel_file, file_name='survey_responses.xlsx', mime='application/vnd.openxmlformats-officedocument.spreadsheetml.sheet')
